...
# TARSIOBUILDROOT variable in the Makefile that includes tarsio.mk. Binary
# object files can also be separated to be stored in some specific location.
# This is controlled by setting the TARSIOOBJROOT variable in the Makefile
# that includes tarsio.mk
#
# Example:
#
# TARSIOBUILDROOT=../build
# TARSIOOBJROOT=../objs
#
...
# code. This is controlled by setting the TARSIOTESTROOT variable in the
...
# is controlled by the TARSIOSRCROOT variable in the Makefile that includes
# tarsio.mk
#
# Example:
#
...
# TARSIOTMPROOT varialbe in the Makefile that includes tarsio.mk
#
# Example:
#
# TARSIOTMPROOT=/tmp/$USER/my_project
#
Q?=@
...
${TTMPROOT}%_mocks.c: ${TTMPROOT}%.sym ${TINCROOT}%_data.h
	${Q}${TMG} $^ > $@

.PRECIOUS: ${TTMPROOT}%_proxified.pp
.NOTPARALLEL: ${TTMPROOT}%_proxified.pp
${TTMPROOT}%_proxified.pp: ${TTMPROOT}%.sym ${TTMPROOT}%.pp
	${Q}${TAM} $^ > $@

.PRECIOUS: ${TTMPROOT}%_runner.c
${TTMPROOT}%_runner.c: ${TTESTROOT}%_check.c ${TINCROOT}%_data.h
	${Q}${TTG} $^ > $@
