 ...
 * fsize()
 */
check(fsize_shall_use_fseek_the_end_of_the_provided_file_as_base) {
  fsize((FILE*)0x1234);
#ifndef SASC
...
check(fsize_shall_use_ftell_to_determine_the_number_of_bytes) {
  fsize((FILE*)0x1234);
  assert_eq(1, m.ftell.call_count);
  assert_eq((FILE*)0x1234, m.ftell.args.arg0);
}

check(fsize_shall_rewind_to_beginning_of_file_when_done) {
  fsize((FILE*)0x1234);
#ifndef SASC
...
check(fsize_shall_forward_ftell_return_value) {
  m.ftell.retval = 5678;
 ...
 * file_init()
 */
check(init_shall_assert_file_is_not_NULL) {
...
check(init_shall_assert_filename_is_not_NULL) {
...
check(init_shall_open_the_correct_file_for_reading_binary) {
...
check(init_shall_return_1_negative_if_file_can_not_be_opened) {
  m.fopen.retval = NULL;
  assert_eq(-1, file_init((file_t*)0x1234, (char*)0x5678));
}

check(init_shall_get_the_file_size_of_the_correct_file) {
...
check(init_shall_return_2_negative_if_filesize_is_zero) {
  m.fopen.retval = (FILE*)0x1234;
  assert_eq(-2, file_init((file_t*)0x1234, (char*)0x5678));
}

check(init_shall_close_file_if_size_is_zero) {
...
check(init_shall_allocate_enough_memory_for_the_whole_file) {
  m.fopen.retval = (FILE*)0x1234;
  m.fsize.retval = 5678;
  file_init((file_t*)0x4321, (char*)0x5678);
...
check(init_shall_return_3_negative_if_out_of_memory) {
  m.fopen.retval = (FILE*)0x1234;
  m.fsize.retval = 5678;
  assert_eq(-3, file_init((file_t*)0x4321, (char*)0x8765));
}

check(init_shall_read_the_correct_file_to_the_correct_memory) {
  m.fopen.retval = (FILE*)0x1234;
  m.fsize.retval = 5678;
...
check(init_shall_return_4_negative_if_file_is_unreadable) {
  m.fopen.retval = (FILE*)0x1234;
  m.fsize.retval = 5678;
  m.malloc.retval = (void*)0x4321;
...
check(init_shall_free_allocated_memory_on_read_failure) {
  m.fopen.retval = (FILE*)0x1234;
  m.fsize.retval = 5678;
  m.malloc.retval = (void*)0x4321;
  file_init((file_t*)0x1111, (char*)0x2222);
...
check(init_shall_close_file_read_failure) {
  m.fopen.retval = (FILE*)0x1234;
  m.fsize.retval = 5678;
  m.malloc.retval = (void*)0x4321;
  file_init((file_t*)0x1111, (char*)0x2222);
...
check(init_shall_return_0_on_success) {
  file_t file;
  m.fopen.retval = (FILE*)0x1234;
  m.fsize.retval = 5678;
  m.malloc.retval = (void*)0x4321;
...
check(init_shall_close_file_on_success) {
  file_t file;
  m.fopen.retval = (FILE*)0x1234;
  m.fsize.retval = 5678;
  m.malloc.retval = (void*)0x4321;
...
check(init_shall_load_the_file_into_the_corrct_memory) {
  file_t file;
  m.fopen.retval = (FILE*)0x1234;
  m.fsize.retval = 5678;
  m.malloc.retval = (void*)0x4321;
 ...
 * file_cleanup()
 */
check(cleanup_shall_assert_file_is_not_NULL) {
...
check(cleanup_shall_not_free_loaded_file_if_not_allocated) {
  file_t file;
  file.buf = NULL;
  file_cleanup(&file);
...
check(cleanup_shall_free_loaded_file_in_memory) {
  file_t file;
